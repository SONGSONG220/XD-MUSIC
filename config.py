...
# -------------------------------------------------------
OWNER_USERNAME = getenv("OWNER_USERNAME","ll_MR_OXYGEN_ll")
# --------------------------------------------------------
...
# ----------------------------------------------------------------
LOGGER_ID = int(getenv("LOGGER_ID", -1002468653401))
# ----------------------------------------------------------------
# ----------------------------------------------------------------
OWNER_ID = int(getenv("OWNER_ID", 7861732958))
# -----------------------------------------------------------------
# -----------------------------------------------------------------
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/yourtoofan/XD-MUSIC",
)
...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/+Vf7kvdoQaCM2ZTRl")
# ------------------------------------------------------------------------------
# -------------------------------------------------------------------------------
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://files.catbox.moe/xa0gec.jpg"
)
PING_IMG_URL = getenv(
    "PING_IMG_URL", "https://files.catbox.moe/xa0gec.jpg"
)
PLAYLIST_IMG_URL = "https://files.catbox.moe/xa0gec.jpg"
...
YOUTUBE_IMG_URL = "https://files.catbox.moe/xa0gec.jpg"
